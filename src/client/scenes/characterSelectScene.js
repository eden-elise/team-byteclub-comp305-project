        ...
        this.characters = [
            {
                id: 'knight',
                Class: Knight,
                description: "A stalwart defender of the realm, clad in heavy armor. The Knight excels in defense and possesses balanced offensive capabilities, making them a reliable choice for any encounter."
            },
            {
                id: 'archer',
                Class: Archer,
                description: "A swift and precise marksman from the elven forests. The Archer relies on high speed and luck to outmaneuver foes, dealing critical strikes from a distance while avoiding counterattacks."
            }
        ];
